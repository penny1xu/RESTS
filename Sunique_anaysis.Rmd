...
```{r}
# omit na columns
data_ACT<-data_ACT[, which(colMeans(!is.na(data_ACT)) > 0.8)]

#sign into a new columns
data_ACT$subdivision_first_letter <- NA
#get first letter in for subdivision column
...
```{r}
#year difference
data_ACT$Building_Year <- NA
data_ACT[data_ACT$Year.Built <= 1990, "Building_Year"]<- "1990-"
data_ACT[data_ACT$Year.Built > 1990 & data_ACT$Year.Built <= 2011, "Building_Year"] <- "1990-2011"
data_ACT[data_ACT$Year.Built > 2011 & data_ACT$Year.Built <= 2021, "Building_Year"] <- "2011-2021"
data_ACT[data_ACT$Year.Built == 2022 , "Building_Year"] <- "2022"
```
